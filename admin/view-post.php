         ...
         <div class="col-lg-12 ">
            <div class="card">
               <div class="card-header d-flex justify-content-between align-items-center">
                  <h5 class="card-title p-0 m-0">View Post</h5>
                  <a href="add-post.php" class="btn btn-primary btn-sm btn-rounded">Add Post</a>
               </div>
               <div class="card-body">
               <div class="table-responsive">
                  <table class="table table-bordered list-tbl caption-top text-center">
                  <caption><small >List of Post</small></caption>
                     ...
                     <tbody>
                        <?php
                           $query = "SELECT blog.*, category.name AS category_name FROM posts blog, categories category WHERE category.id = blog.category_id AND blog.status IN(0,1)";
