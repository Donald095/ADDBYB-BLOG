         ...
         <div class="col-lg-12 ">
            <div class="card">
               <div class="card-header d-flex justify-content-between align-items-center">
                  <h5 class="card-title p-0 m-0">Trash Post</h5>
                  <a href="view-post.php" class="btn btn-primary btn-sm btn-rounded">View Post</a>
               </div>
               <div class="card-body">
                  ...
                  <caption><small >List of Trash</small></caption>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <button type="submit" name="post_active" value="<?=$row['id'];?>" class="btn btn-success btn-sm btn-rounded py-0 px-2">Active</button>
                           </form>
                              </td>
                           <td class="align-middle">
                           <form action="delete-qury.php" method="POST">  
                           <button type="submit" name="post_delete" value="<?=$row['id'];?>" class="btn btn-danger btn-sm btn-rounded py-0 px-2">Delete</button>
                           </form>
                        </td>
                        </tr>
